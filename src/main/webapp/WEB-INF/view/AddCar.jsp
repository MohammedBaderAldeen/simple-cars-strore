...
<body>
	...
	parametars=(Parametars) request.getAttribute("parametars");
	%>
	...
	<div class="container text-center">
		...
		<form class="form-horizontal" method="POST" action="addCar">
			...
			<div class="form-group">
				<label class="control-label col-md-3">Name Car</label>
				<div class="col-md-7">
					<input type="text" required class="form-control" name="name_car" 
						 />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" required class="form-control" name="count_seat" 
